...
class ModelAdjacencyEntry(BaseModel):
    """Reverse-dependency entry for a single source module."""
...
class ModelThresholds(BaseModel):
    """Escalation thresholds controlling when the full suite fires."""
...
class ModelAdjacencyMap(BaseModel):
    """Full adjacency map loaded from the YAML file."""
