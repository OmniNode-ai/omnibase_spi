...
class OmniStructureValidator:
    ...
    def validate_forbidden_directories(self) -> None:
    ...
    def validate_model_organization(self) -> None:
    ...
    def validate_enum_organization(self) -> None:
    ...
    def validate_protocol_locations(self) -> None:
    ...
    def validate_node_structure(self) -> None:
    ...
    def validate_test_structure(self) -> None:
...
def print_validation_report(
    violations: List[StructureViolation], repo_name: str
) -> bool:
