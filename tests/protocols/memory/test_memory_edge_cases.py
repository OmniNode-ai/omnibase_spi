...
class MockMemoryEffectNode:
    ...
    async def store_memory(self, request, security_context=None, timeout_seconds=None):
        self.call_count += 1
...
class MockSecurityContext:
    ...
    def __init__(self, user_id=None, permissions=None, access_level="public"):
