...
class TestLegacyModuleDeprecationWarning:
    ...
    def _import_legacy_module_fresh(self) -> ModuleType:
        ...
        modules_to_remove = [
            key for key in sys.modules if key.startswith("omnibase_spi.protocols.nodes.legacy")
        ]
    ...
    def test_deprecation_warning_includes_version(self) -> None:
        ...
        with warnings.catch_warnings(record=True) as caught_warnings:
            ...
            version_mentioned = any("0.5.0" in str(w.message) for w in deprecation_warnings)
    ...
    def test_deprecation_warning_includes_migration_guidance(self) -> None:
        ...
        with warnings.catch_warnings(record=True) as caught_warnings:
            ...
            guidance_mentioned = any(
                "omnibase_spi.protocols.nodes" in str(w.message) for w in deprecation_warnings
            )
    ...
    def test_deprecation_warning_message_content(self) -> None:
        ...
        with warnings.catch_warnings(record=True) as caught_warnings:
            ...
            assert "0.5.0" in warning_message, f"Expected '0.5.0' in message: {warning_message}"
            assert "legacy" in warning_message.lower(), (
...
class TestLegacyProtocolsAreRuntimeCheckable:
    ...
    def test_compute_node_legacy_is_runtime_checkable(self) -> None:
        ...
        with warnings.catch_warnings():
            ...
            assert hasattr(ProtocolComputeNodeLegacy, "_is_runtime_protocol") or hasattr(
                ProtocolComputeNodeLegacy, "__runtime_protocol__"
            )
    ...
    def test_reducer_node_legacy_is_runtime_checkable(self) -> None:
        ...
        with warnings.catch_warnings():
            ...
            assert hasattr(ProtocolReducerNodeLegacy, "_is_runtime_protocol") or hasattr(
                ProtocolReducerNodeLegacy, "__runtime_protocol__"
            )
    ...
    def test_orchestrator_node_legacy_is_runtime_checkable(self) -> None:
        ...
        with warnings.catch_warnings():
            warnings.simplefilter("ignore", DeprecationWarning)
            from omnibase_spi.protocols.nodes.legacy import ProtocolOrchestratorNodeLegacy

            assert hasattr(ProtocolOrchestratorNodeLegacy, "_is_runtime_protocol") or hasattr(
                ProtocolOrchestratorNodeLegacy, "__runtime_protocol__"
            )
...
class TestLegacyProtocolMigrationInfo:
    ...
    def test_compute_node_legacy_docstring_has_migration_guide(self) -> None:
        ...
        with warnings.catch_warnings():
            ...
            assert has_migration_info, f"Expected migration info in docstring: {docstring}"
